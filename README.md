# Aquatic SMP Helper - Ultimate Discord Bot
**Aquatic SMP Helper** is a powerful, feature-rich Discord bot designed to enhance your server experience with comprehensive moderation tools, engaging economy systems, utility features, and much more. Built with modern Discord.js v14 and PostgreSQL for optimal performance and data persistence.
...
Aquatic SMP Helper offers a complete suite of tools for Discord server management and community engagement:
...
[**Aquatic SMP Helper Setup Tutorial**](https://www.youtube.com/@TouchDisc)

## Docker Deployment (Recommended)

Aquatic SMP Helper is fully containerized for easy deployment.

1. **Clone the repository:**
   ```bash
   git clone https://github.com/codebymitch/Aquatic SMP Helper.git
   cd Aquatic SMP Helper
   ```
...
```bash
docker pull ghcr.io/codebymitch/aquatic-smp-helper:main
```
...
3. **Configure Environment Variables**
   ...
   POSTGRES_URL=postgresql://postgres:yourpassword@localhost:5432/aquatic-smp-helper
   POSTGRES_HOST=localhost
   POSTGRES_PORT=5432
   POSTGRES_DB=aquatic-smp-helper
   ...
   - If your chosen `PORT` is already used, Aquatic SMP Helper automatically tries the next port(s)
...
4. **Setup PostgreSQL Database** (Optional but recommended)
   ...
   createdb aquatic-smp-helper
   createuser aquatic-smp-helper
   psql -c "ALTER USER aquatic-smp-helper PASSWORD 'yourpassword';"
   psql -c "GRANT ALL PRIVILEGES ON DATABASE aquatic-smp-helper TO aquatic-smp-helper;"
   ```
...
Aquatic SMP Helper requires the following Discord intents:
- **Guilds**
- **Guild Messages**
- **Message Content**
- **Guild Members**
...
We welcome contributions to Aquatic SMP Helper! Here's how you can help:
...
Aquatic SMP Helper is released under the MIT License. See [LICENSE](LICENSE) for details.

## Thank You

Thank you for choosing Aquatic SMP Helper for your Discord server! We're constantly working to improve and add new features based on community feedback.

# Security Policy — Aquatic SMP Helper
...
If you operate a self-hosted Aquatic SMP Helper instance and suffer a security incident:
...
- If you need upstream help, file a private security advisory and include sanitized reproduction steps and the Aquatic SMP Helper version/commit.
...
## Privacy & Telemetry
- Aquatic SMP Helper does not phone home or collect usage data by default. (If you plan to add telemetry, it must be opt-in, documented, and transparent.)
...
Thank you for helping keep Aquatic SMP Helper safe.

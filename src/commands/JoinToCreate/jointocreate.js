...
import { AquaticSMPHelperError, ErrorTypes } from '../../utils/errorHandler.js';
    ...
    async execute(interaction, config, client) {
        try {
            ...
            if (!hasManageGuildPermission(interaction.member)) {
                throw new AquaticSMPHelperError(
            ...
            try {
                ...
                if (error instanceof AquaticSMPHelperError) {
                    ...
                    logger.debug(`AquaticSMPHelperError [${error.type}]: ${error.message}`, error.context || {});
                } else {
    ...
    try {
        ...
        collector.on('collect', async (buttonInteraction) => {
            try {
                ...
                const userMessage = error instanceof AquaticSMPHelperError

...
export const pgConfig = {
    url: process.env.POSTGRES_URL || 'postgresql://localhost:5432/aquatic-smp-helper',
    
    options: {
        
        host: process.env.POSTGRES_HOST || 'localhost',
        port: parseInt(process.env.POSTGRES_PORT) || 5432,
        database: process.env.POSTGRES_DB || 'aquatic-smp-helper',
        ...
        application_name: 'aquatic-smp-helper',

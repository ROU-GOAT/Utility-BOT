 ...
 * 
 * This module provides structured error handling for the Aquatic SMP Helper application.
 * 
 * PHILOSOPHY:
 ...
 * 
 * USAGE:
 * - Throw AquaticSMPHelperError for application-specific errors
...
export class AquaticSMPHelperError extends Error {
    constructor(message, type = ErrorTypes.UNKNOWN, userMessage = null, context = {}) {
        super(message);
        this.name = 'AquaticSMPHelperError';
        this.type = type;
...
export function categorizeError(error) {
    if (error instanceof AquaticSMPHelperError) {
        return error.type;
    }
...
export function createError(message, type = ErrorTypes.UNKNOWN, userMessage = null, context = {}) {
    ...
    return new AquaticSMPHelperError(message, type, userMessage, normalizedContext);
}

export default {
    ErrorTypes,
    AquaticSMPHelperError,
    categorizeError,
    getUserMessage,
